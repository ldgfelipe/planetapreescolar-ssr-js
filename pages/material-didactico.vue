<template>
  ...
  return app.$fire.firestore.collection('CATEGORIAS')
    ...
    data() {
      return {
        titulo:"Material didáctico para los niños",
            subtitulo:"Loterías, memoramas, juegos, dominós, frisos, gafetes, reglamentos a todo color.",
        subtipo: "materialdidactico",
        buscando: false,
        arrayrecursosMas:[],
        last:null
      };
